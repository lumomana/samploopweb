...
const translations: Record<Locale, TranslationCatalog> = {
  fr: {
    ...
    heroTitle: "9 pistes, bibliothèque hors ligne, ajoutez vos sons et créez vos ambiances.",
  ...
  en: {
    ...
    webLoopStation: "Samploop",
    heroTitle: "9 tracks, offline library, add your sounds and create your moods.",
  ...
  es: {
    ...
    webLoopStation: "Samploop",
    heroTitle: "9 pistas, biblioteca sin conexión, añade tus sonidos y crea tus ambientes.",
  ...
  ar: {
    ...
    heroTitle: "٩ مسارات، مكتبة دون اتصال، أضف أصواتك وأنشئ أجواءك.",
  ...
  ja: {
    ...
    heroTitle: "9トラック、オフラインライブラリ、サウンドを追加してムードを作ろう。",
